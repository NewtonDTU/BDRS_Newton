...
from ball_alignment2 import run_ball_alignment, stop_robot
...
if __name__ == "__main__":
    ...
    if service.connected:
        edge.setup()
        edge.lineKp = 0.3 # this makes the robot follow the line more tightly, which is needed for the ramp
        edge.lineTauz = 1.0  # this makes the robot turn more sharply, which is needed for the ramp
        edge.lineTaup = 0.35 # this make
        Gripper().open()
